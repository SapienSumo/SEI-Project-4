    ...
    return (
      <section className="section home-container" id="background-change" style={{
        ...
        <div className="container title-container has-text-centered">
          ...
          {!Auth.isAuthenticated() && <Link to="/register"><button className="button is-warning">Sign Up</button></Link> || <Link to="/booksshow"><button className="button is-warning">ARCHIVES</button></Link>}
        </div>
      </section>
    )
  }
